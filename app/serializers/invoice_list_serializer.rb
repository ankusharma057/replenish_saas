class InvoiceListSerializer < ActiveModel::Serializer
  ...
  attributes :id, :employee_id, :client_id, :charge, :is_finalized, :date_of_service, :paid_by_client_cash, :paid_by_client_credit, :amt_paid_for_products, :payment_type, :amt_paid_for_retail_products, :amt_paid_for_wellness_products, :comments, :personal_discount, :tip, :concierge_fee_paid, :gfe, :provider_purchased, :overhead_fee_type, :overhead_fee_value, :products_hash, :source_invoice_id, :employee, :client, :location, :is_paid, :stripe_account_id, :created_at, :instant_pay, :payment_status
