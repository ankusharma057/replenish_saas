...
class Api::EmployeesController < ApplicationController
  ...
  def employee_params
    params.permit(:name, :vendor_name, :email, :password, :gfe, :service_percentage, :retail_percentage, :is_admin, :is_inv_manager, :is_mentor, :pay_50, employees_mentors_attributes: [:id, :employee_id, :mentor_id, :mentor_percentage, :_destroy])
  end
