                    ...
                    <Col className="w-50 d-flex flex-column gap-[20px] p-0">
                        <div className="p-3 border w-100 bg-white position-relative rounded">
                            <div className="d-flex gap-[10px]">
                                ...
                                <div className="position-absolute top-[20px] right-[25px] w-auto"><Pencil size={20} color="#22D3EE" /></div>
                            </div>
                            <div className="d-flex gap-[10px]">
                                <div><Phone /></div>
                                <div>
                            ...
                            <div className="d-flex gap-[10px]">
                                ...
                                <div>
                                    ...
                                    {!clientProfileData.is_verified && <p className="text-muted fw-light fs-6">Tester has not verified that this email address belongs to them and that they are successfully receiving emails from Jane. Click here to remind Tester to confirm their email address.</p>}
                                </div>
                            </div>
                            <div className="d-flex gap-[10px]">
                                <div><Home /></div>
